...
def get_arguments():
	...
	return client_grid, num_iterations, is_disjoint_option, file_name, experiment, scope, GPU_NUM,dataset,fix_batch_size,fraction, case_control


def main(client_grid,num_iterations,is_disjoint_option,file_name,experiment,scope, GPU_NUM, dataset,fix_batch_size,fraction, **case_control  ):
...
if __name__ == '__main__':
	client_grid, num_iterations, is_disjoint_option, file_name, experiment,scope, GPU_NUM, dataset,fix_batch_size,fraction, case_control = get_arguments()
	
	main(client_grid, num_iterations, is_disjoint_option, file_name, experiment,scope, GPU_NUM,dataset,fix_batch_size,fraction, **case_control)
